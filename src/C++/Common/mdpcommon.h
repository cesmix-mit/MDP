...
struct latticestruct {     
    ...
    dstype scale;
    int *atomtype=NULL;  // type of basis atoms
...
struct configstruct {    
    ...
    int *pbc=NULL;    // periodic boundary condition flagss
    int *t=NULL;      // atomic types of atoms for all configurations     
    int *move=NULL;   // move flags of atoms for all configurations     
    int *group=NULL;  // atomic groups of atoms for all configurations     
    ...
    dstype *ws=NULL;   // weights on stresses
    dstype *stress=NULL;   // stress
