function genpair(foldername,filename, u, xij, qi, qj, ti, tj, ai, aj, mu, eta, kappa, gen, ifile)
...
if gen==0
    ...
    tmp = strgpu;    
    tmp = replace(tmp, "(T *u, T *xij," => "Gradient(T *u, T *du, T *u_xij, T *xij,");            
    ...
    st2 = replace(st2, "(T *u, T *xij," => "Gradient(T *u, T *du, T *u_xij, T *xij,");  
