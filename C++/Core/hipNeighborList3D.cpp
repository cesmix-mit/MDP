...
#ifndef __HIPNEIGHBORLIST3D
#define __HIPNEIGHBORLIST3D

template <typename T>
__global__ void hipKernelGhostAtoms3D(int *glistnum, int *inside, T *x, T *pimages, 
...
template <typename T>
__global__ void hipKernelAtomList3D(int *alist, int *inside, int *glistnumsum, 
...
template <typename T> void hipAtomList3D(int *alist,  int *inside, int *glistnumsum, int *glistnum, 
...
{                        
    ...
    hipLaunchKernelGGL(hipKernelGhostAtoms3D, gridDim, blockDim, 0, 0, glistnum, inside, x, pimages, wc, s2rmap, inum, pnum, dim);
    ...
    hipLaunchKernelGGL(hipKernelAtomList3D, gridDim, blockDim, 0, 0, alist, inside, glistnumsum, x, pimages, inum, pnum, dim);
}
template void hipAtomList3D(int*, int*, int*, int*, int*, int*, double*, double*, double*, double*, int, int, int);
template void hipAtomList3D(int*, int*, int*, int*, int*, int*, float*, float*, float*, float*, int, int, int);

template <typename T>
__global__ void hipKernelCellList3D(int *clist, T *x, T *eta1, T *eta2, T *eta3, T *s2rmap, 
...
template <typename T> void hipCellList3D(int *clist, T *xi, T *eta1, T *eta2, T *eta3, T *s2rmap, 
        int *nc, int inum, int natom, int dim)
{                        
    int blockDim = 256;
    ...
    hipLaunchKernelGGL(hipKernelCellList3D, gridDim, blockDim, 0, 0, clist, xi, eta1, eta2, eta3, s2rmap, 
        nc, inum, natom, dim);
}
template void hipCellList3D(int*, double*, double*, double*, double*, double*, int*, int, int, int);
template void hipCellList3D(int*, float*, float*, float*, float*, float*, int*, int, int, int);


template <typename T> 
__global__ void hipKernelFullNeighborList3D(int *neighborlist, int *neighbornum, T *x, T *rcutsq, int *alist, 
...
template <typename T> void hipFullNeighborList3D(int *neighborlist, int *neighbornum, T *x, T *rcutsq,
...
{                        
    ...
    hipLaunchKernelGGL(hipKernelFullNeighborList3D, gridDim, blockDim, 0, 0, neighborlist, neighbornum, 
            x, rcutsq, alist, clist, c2alist, c2anumsum, nc, inum, jnum, dim);
}
template void hipFullNeighborList3D(int*, int*, double*, double*, int*, int*, int*, int*, int*, int, int, int);
template void hipFullNeighborList3D(int*, int*, float*, float*, int*, int*, int*, int*, int*, int, int, int);


template <typename T> 
__global__ void hipKernelFullNeighborList3D(int *neighborlist, int *neighbornum, T *x, T *rcutsq, 
...
template void hipFullNeighborList3D(int*, int*, double*, double*, int, int, int, int);
template void hipFullNeighborList3D(int*, int*, float*, float*, int, int, int, int);
