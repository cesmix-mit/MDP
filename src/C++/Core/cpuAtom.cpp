...
template int cpuSetAtomType(double *x, double fraction, int *atomtype, int *seed, int *save, int seed0,  
        int newtype, int dim, int nlocal);
template int cpuSetAtomType(float *x, float fraction, int *atomtype, int *seed, int *save, int seed0,  
        int newtype, int dim, int nlocal);
