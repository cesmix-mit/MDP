...
// lib = Libdl.dlopen("mylib.dylib")
// sym = Libdl.dlsym(lib, :test_empty)
// ccall(sym, Cvoid, ())
// testadd = Libdl.dlsym(lib, :test_add)
// ccall(testadd, Cfloat, (Cfloat, Cfloat), 1.5, 2.5)
...
// y = [1.3, -2.7, 4.4, 3.1]
// z = [1.3, -2.7, 4.4, 3.1]
// addarray = Libdl.dlsym(lib, :test_add_array)
// ccall(addarray, Cvoid, (Ptr{Cdouble}, Ptr{Cdouble}, Ptr{Cdouble}, Cint), x, y, z, 4)
