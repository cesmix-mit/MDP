...
int cpuMergeSort(int *list, int *sorted, int n)
{
...
// }
// 
// void cgcoefficients(double *cg, int *indm, int *rowm, int *indl, double *fac, int M, int N)
// {                   
...
// }
// 
// int cpuSphericalHarmonicsBispectrumIndex(double *b, int L)
// {               
//     int N = L+1;
//     int inc = 0;
//     for (int l=0; l<N; l++)     
...
// }
// 
// void cpuSphericalHarmonicsBispectrumIndex(int *indl, double *b, int M, int L)
// {    
//     int N = L+1;
//     int inc = 0;
//     for (int l=0; l<N; l++)     
