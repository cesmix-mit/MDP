...
app.traininglist = reshape(0:9,1,10);  # a list of configurations for training the potential
app.validatelist = reshape(0:100,1,101);# a list of configurations for validating the potential
...
app.potentialform = 1;# 0 -> empirical potential, 1 -> ML potential, 2 -> combined empirical+ML potential    
...
app.descriptor = 0;   # 0 -> Spherical Harmonics Bessel
app.spectrum = 0;     # 0 -> power spectrum, 1-> bispectrum, 2-> both power and bispectrum 
app.chemtype = 0;     # 0 -> single atom-type basis functions, 1 -> pair atom-type basis functions  
app.K = 6;            # number of roots of radial basis functions
