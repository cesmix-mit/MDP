...
app.appname = "snapInP" + num2str(nlattice);
...
app.lattice = setlattice("diamond", 5.83,[],[],[],[],basisatomtype);
...
app.rcutml = 2*app.snaprcutfac*max(app.snapelemradius); % maximum cut-off radius for nonparametric potential

% parametric potential descriptors
app.potentialfile = "ZBLpotentialInP";   % empirical potential file
zblcutinner = 4;
zblcutouter = 4.2;
zblz1 = 49;
zblz2 = 15;
