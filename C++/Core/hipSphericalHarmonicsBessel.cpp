...
#ifndef MDP_HIPSPHERICALHARMONICSBESSEL
#define MDP_HIPSPHERICALHARMONICSBESSEL
...
// core function
template <typename T> __global__ void hipKernelSphericalHarmonicsBessel(T *Sr, T *Si, T *x, T *y, T *z, 
...
template <typename T> void hipSphericalHarmonicsBessel(T *Sr, T *Si, T *x, T *y, T *z, 
                T *x0, T *P, T *tmp, T *f, T *fac, T pi, int L, int K, int N)
{        
    int blockDim = 256;
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBessel, gridDim, blockDim, 0, 0, Sr, Si, x, y, z, 
            x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBessel(double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBessel(float*, float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);

// core function
template <typename T> __global__ void hipKernelSphericalHarmonicsBessel(T *Sr, T *Si, T *xij, 
                T *x0, T *fac, T pi, int L, int K, int N)
{                        
    // L                     : the maximum degree of spherical harmonics
    // K                     : the maximum degree of spherical Bessel functions
...
template <typename T> void hipSphericalHarmonicsBessel(T *Sr, T *Si, T *xij, 
                T *x0, T *P, T *tmp, T *f, T *fac, T pi, int L, int K, int N)
{        
    int blockDim = 256;
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBessel, gridDim, blockDim, 0, 0, Sr, Si, xij, 
            x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBessel(double*, double*, double*, double*, 
        double*, double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBessel(float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);

// core function
template <typename T> __global__ void hipKernelSphericalHarmonicsBesselWithDeriv(T *Sr, T *Si,
...
template <typename T> void hipSphericalHarmonicsBesselWithDeriv(T *Sr, T *Si,
        T *Srx, T *Six, T *Sry, T *Siy, T *Srz, T *Siz, T *x, T *y, T *z, 
...
{        
    ...
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBesselWithDeriv, gridDim, blockDim, 0, 0, Sr, Si, Srx, Six, Sry, Siy, Srz, Siz, x, y, z,
                 x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBesselWithDeriv(double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, double*, double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBesselWithDeriv(float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, float*, 
...
{        
    ...
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBesselWithDeriv, gridDim, blockDim, 0, 0, Sr, Si, Srx, Six, Sry, Siy, Srz, Siz, xij,
                 x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBesselWithDeriv(double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBesselWithDeriv(float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);


// core function
template <typename T> __global__ void hipKernelSphericalHarmonicsBesselJ(T *Sr, T *Si, T *xij, 
                T *x0, T *fac, T pi, int L, int K, int N)
{                        
    // L                     : the maximum degree of spherical harmonics
    // K                     : the maximum degree of spherical Bessel functions
...
template <typename T> void hipSphericalHarmonicsBesselJ(T *Sr, T *Si, T *xij, 
                T *x0, T *P, T *tmp, T *f, T *fac, T pi, int L, int K, int N)
{        
    int blockDim = 256;
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBesselJ, gridDim, blockDim, 0, 0, Sr, Si, xij, 
            x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBesselJ(double*, double*, double*, double*, 
        double*, double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBesselJ(float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);

// core function
template <typename T> __global__ void hipKernelSphericalHarmonicsBesselJWithDeriv(T *Sr, T *Si,
...
template <typename T> void hipSphericalHarmonicsBesselJWithDeriv(T *Sr, T *Si,
        T *Srx, T *Six, T *Sry, T *Siy, T *Srz, T *Siz, T *xij, 
        T *x0, T *P, T *tmp, T *f, T *dP, T *dtmp, T *df, T *fac, T pi, int L, int K, int N)
{        
    int blockDim = 256;
    int gridDim = (N + blockDim - 1) / blockDim;
    gridDim = (gridDim>1024)? 1024 : gridDim;
    hipLaunchKernelGGL(hipKernelSphericalHarmonicsBesselJWithDeriv, gridDim, blockDim, 0, 0, Sr, Si, Srx, Six, Sry, Siy, Srz, Siz, xij,
                 x0, fac, pi, L, K, N);
}
template void hipSphericalHarmonicsBesselJWithDeriv(double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double, int, int, int);
template void hipSphericalHarmonicsBesselJWithDeriv(float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);
