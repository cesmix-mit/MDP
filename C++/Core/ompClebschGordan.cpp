...
#ifndef MDP_OMPCLEBSCHGORDAN
#define MDP_OMPCLEBSCHGORDAN 

void ompGetIndk(int *indk, int K)
{               
...
// core function
template <typename T> void ompSphericalHarmonicsAtomSum(T *Ylmr, T *Ylmi, T *x, T *y, T *z, 
...
template void ompSphericalHarmonicsAtomSum(double*, double*, double*, double*, double*, double*, double*, double*, double, int, int);
template void ompSphericalHarmonicsAtomSum(float*, float*, float*, float*, float*, float*, float*, float*, float, int, int);

// core function
template <typename T> void ompSphericalHarmonicsBispectrum(T *b, T *Ylmr, T *Ylmi, T *fac, int L)
{                   
    // L                    : the maximum degree of spherical harmonics
...
template void ompSphericalHarmonicsBispectrum(double*, double*, double*, double*, int);
template void ompSphericalHarmonicsBispectrum(float*, float*, float*, float*, int);

// core function
template <typename T> int ompSphericalHarmonicsBispectrumIndex(T *b, int L)
{               
    // L : the maximum degree of spherical harmonics    
...
template int ompSphericalHarmonicsBispectrumIndex(double *, int);
template int ompSphericalHarmonicsBispectrumIndex(float *, int);

// core function
template <typename T> void ompSphericalHarmonicsBispectrumIndex(int *indl, T *b, int M, int L)
{    
    // L    : the maximum degree of spherical harmonics    
...
template void ompSphericalHarmonicsBispectrumIndex(int*, double *, int, int);
template void ompSphericalHarmonicsBispectrumIndex(int*, float *, int, int);
