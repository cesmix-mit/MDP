#ifndef __CPUSPHERICALHARMONICSBESSEL
#define __CPUSPHERICALHARMONICSBESSEL
...
template void cpuSphericalHarmonicsBesselJ(double*, double*, double*, double*, 
        double*, double*, double*, double*, double, int, int, int);
template void cpuSphericalHarmonicsBesselJ(float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);

// core function
template <typename T> void cpuSphericalHarmonicsBesselJWithDeriv(T *Sr, T *Si,
        T *Srx, T *Six, T *Sry, T *Siy, T *Srz, T *Siz, T *xij, T *x0, T *P, 
        T *tmp, T *f, T *dP, T *dtmp, T *df, T *fac, T pi, int L, int K, int N)
{                        
    // L                      : the maximum degree of spherical harmonics
...
template void cpuSphericalHarmonicsBesselJWithDeriv(double*, double*, double*, double*, double*, 
        double*, double*, double*, double*, double*, double*, double*, double*, double*, 
        double*, double*, double*, double, int, int, int);
template void cpuSphericalHarmonicsBesselJWithDeriv(float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float*, float*, float*, float*, 
        float*, float*, float*, float*, float, int, int, int);
