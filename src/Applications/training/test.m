...
app.traininglist = 1:80;  % a list of configurations for training the potential
app.validatelist = 61:101;% a list of configurations for validating the potential
...
app.K = 3;            % number roots of radial basis functions
