...
//     void BondedQuadrupletEnergyForce(dstype *e, dstype *f, dstype *x, dstype *q, dstype *param, Int nparam); 
    ...
    void EmpiricalPotentialDescriptors(dstype *e, dstype *f, dstype *v, dstype *x, dstype *q, dstype *param, Int *nparam);     
    ...
    void PotentialDescriptors(dstype *e, dstype *f, dstype *v, 
