...
#ifndef MDP_OMPNEIGHCOUNT
#define MDP_OMPNEIGHCOUNT

int ompFindAtomType(int *tlist, int* ilist, int *atomtype, int *p, int *q, int typei, int inum)
{
    // form binary array p
...
template <typename T> void ompNeighSingles(T *xi, T *qi, T *x, T *q, int *ai, 
...
template void ompNeighSingles(double*, double*, double*, double*, int*, int*, int*, int*,  int, int, int);
template void ompNeighSingles(float*, float*, float*, float*, int*, int*, int*, int*, int, int, int);

template <typename T> void ompFullNeighPairList(int *pairnum, int *pairlist, T *x, T *rcutsq, int *ilist, int *neighlist, 
...
template void ompFullNeighPairList(int *, int *, double*, double*, int*, int*, int*, int, int, int);
template void ompFullNeighPairList(int *, int *, float*, float*, int*, int*, int*, int, int, int);

template <typename T> void ompFullNeighPairList(int *pairnum, int *pairlist, T *x, T *rcutsq,  int *atomtype, int *ilist, int *alist, 
...
template void ompFullNeighPairList(int *, int *, double*, double*, int*, int*, int*, int*, int*, int, int, int, int);
template void ompFullNeighPairList(int *, int *, float*, float*, int*, int*, int*, int*, int*, int, int, int, int);
...
template void ompFullNeighPairList(int *, int *, double*, double*, int*, int*, int*, int*, int*, int, int, int, int, int);
template void ompFullNeighPairList(int *, int *, float*, float*, int*, int*, int*, int*, int*, int, int, int, int, int);
...
template void ompFullNeighPairList(int *, int *, double*, double*, int*, int*, int*, int*, int*, int, int, int, int, int, int);
template void ompFullNeighPairList(int *, int *, float*, float*, int*, int*, int*, int*, int*, int, int, int, int, int, int);

template <typename T> void ompHalfNeighPairList(int *pairnum, int *pairlist, T *x, T *rcutsq, int *ilist, int *alist, 
...
template void ompHalfNeighPairList(int *, int *, double*, double*, int*, int*, int*, int*, int, int, int);
template void ompHalfNeighPairList(int *, int *, float*, float*, int*, int*, int*, int*, int, int, int);

template <typename T> void ompHalfNeighPairList(int *pairnum, int *pairlist, T *x, T *rcutsq, int *atomtype, int *ilist, 
...
template void ompHalfNeighPairList(int *, int *, double*, double*, int*, int*, int*, int*, int*, int, int, int, int);
template void ompHalfNeighPairList(int *, int *, float*, float*, int*, int*, int*, int*, int*, int, int, int, int);

template <typename T> void ompNeighPairs(T *xij, T *qi, T *qj, T *x, T *q, int *ai, int *aj,  
...
template void ompNeighPairs(double*, double*, double*, double*, double*, int*, int*, int*, int*, 
        int*, int*, int*, int*, int*, int*, int, int, int, int);
template void ompNeighPairs(float*, float*, float*, float*, float*, int*, int*, int*, int*, 
        int*, int*, int*, int*, int*, int*, int, int, int, int);

// void ompFullNeighTripletList(int *tripletnum, int *tripletlist, int *atomtype, int *ilist, int *alist, 
...
// template <typename T> void ompNeighTripletList(int *tripletnum, int *tripletlist, T *x, T rcutsq, int *atomtype, int *ilist,
...
//     }
// }
// template void ompNeighTripletList(int *, int *, double*, double, int*, int*, int*, int*, int*, int, int, int, int, int, int);
// template void ompNeighTripletList(int *, int *, float*, float, int*, int*, int*, int*, int*, int, int, int, int, int, int);

// template <typename T> void ompNeighTriplets(T *xij, T *xik, T *qi, T *qj, T *qk, T *x, T *q, int *ai, int *aj, int *ak,  
...
//     }    
// }
// template void ompNeighTriplets(double*, double*, double*, double*, double*, double*, double*, int*, int*, int*, int*, 
//         int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int, int);
// template void ompNeighTriplets(float*, float*, float*, float*, float*, float*, float*, int*, int*, int*, int*, 
//         int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int, int);

void ompNeighTripletList(int *tripletlist, int *tripletnumsum, int *pairnum, 
...
template <typename T> void ompNeighTripletList(int *tripletnum, int *tripletlist, T *x, T *rcutsq, int *pairnum, int *pairnumsum, 
...
template void ompNeighTripletList(int *, int *, double*, double*, int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int);
template void ompNeighTripletList(int *, int *, float*, float*, int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int);
...
// template <typename T> void ompNeighQuadrupletList(int *quadrupletnum, int *quadrupletlist, T *x, T rcutsq, int *atomtype, int *ilist,
...
//     }
// }
// template void ompNeighQuadrupletList(int *, int *, double*, double, int*, int*, int*, int*, int*, int, int, int, int, int, int, int);
// template void ompNeighQuadrupletList(int *, int *, float*, float, int*, int*, int*, int*, int*, int, int, int, int, int, int, int);
// 
// template <typename T> void ompNeighQuadruplets(T *xij, T *xik, T *xil, T *qi, T *qj, T *qk, T *ql, T *x, T *q, 
...
//     }    
// }
// template void ompNeighQuadruplets(double*, double*, double*, double*, double*, double*, double*, double*, double*, int*, int*, int*, int*, 
//         int*, int*, int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int, int);
// template void ompNeighQuadruplets(float*, float*, float*, float*, float*, float*, float*, float*, float*, int*, int*, int*, int*, 
//         int*, int*, int*, int*, int*, int*, int*, int*, int*, int*, int, int, int, int, int);


void ompNeighQuadrupletList(int *quadrupletlist, int *quadrupletnumsum, int *pairnum, 
        int *pairlist, int *ilist, int *alist, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
...
void ompNeighCountFullTriplet(int *anum, int *ilist, int *neighnum, int inum)
{    
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
        int i = ilist[ii];       // atom i
...
void ompNeighCountFullTriplet(int *anum, int *bnum, int *atomtype,  int *ilist, int *alist, int *neighlist, int *neighnum, 
...
void ompNeighCountFullPairTriplet(int *anum, int *bnum, int *cnum, int *atomtype, int *ilist, int *alist, int *neighlist, int *neighnum, 
...
void ompNeighCountFullTriplet(int *anum, int *bnum, int *cnum, int *atomtype, int *ilist, int *alist, int *neighlist, int *neighnum, 
        int typej, int typek, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
...
void ompNeighCountHalfTriplet(int *anum, int *ilist, int *alist, int *neighlist, int *neighnum, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
        int i = ilist[ii];       // atom i
...
void ompNeighCountHalfTriplet(int *anum, int *bnum, int *atomtype, int *ilist, int *alist, int *neighlist, int *neighnum, 
        int typej, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
...
void ompNeighCountHalfPairTriplet(int *anum, int *bnum, int *cnum, int *atomtype, int *ilist, int *alist, int *neighlist, int *neighnum, 
        int typej, int typek, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
...
void ompNeighCountHalfTriplet(int *anum, int *bnum, int *cnum, int *atomtype, int *ilist, int *alist, int *neighlist, int *neighnum, 
        int typej, int typek, int inum, int jnum)
{        
    #pragma omp parallel for
    for (int ii=0; ii<inum; ii++) {
