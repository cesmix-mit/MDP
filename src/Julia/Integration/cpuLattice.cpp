        ...
        double *a1, double *a2, double *a3, int *orientx, int *orienty, int *orientz)
{
  ...
  double determinant = primitive[0*3+0]*primitive[1*3+1]*primitive[2*3+2] +
        ...
        double *spacing, double scale, int dim)
{
  if (dim==3) {
      ...
      double x1 = rotatecol[0*3+0]*x[0] + rotatecol[0*3+1]*x[1] + rotatecol[0*3+2]*x[2];
      double y1 = rotatecol[1*3+0]*x[0] + rotatecol[1*3+1]*x[1] + rotatecol[1*3+2]*x[2];
      double z1 = rotatecol[2*3+0]*x[0] + rotatecol[2*3+1]*x[1] + rotatecol[2*3+2]*x[2];
      ...
      double x1 = rotatecol[0*3+0]*x[0] + rotatecol[0*3+1]*x[1];
      double y1 = rotatecol[1*3+0]*x[0] + rotatecol[1*3+1]*x[1];
