...
// //     if (backend==2) { // GPU
// // #ifdef HAVE_CUDA        
// //         CUDA_CHECK( cudaMemcpy(nb.bcs, cconf.config.bcs, 6*sizeof(Int), cudaMemcpyHostToDevice ) );              
// //         CUDA_CHECK( cudaMemcpy(nb.simbox, cconf.config.simbox, 9*sizeof(dstype), cudaMemcpyHostToDevice ) );              
// // #endif        
// //     }    
// //     else { // CPU
// //         for (int i=0; i<6; i++)
