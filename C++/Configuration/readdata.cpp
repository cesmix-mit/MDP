    ...
    if (common.readdomain==0) {
        if (common.readregion == 0) 
            ...
            if (common.readlattice==0) {
                ...
                //print1darray(common.lat.spacing, 3);
                //cout<<common.lat.scale<<endl;
                ...
                dstype epsilon[3];
                epsilon[0] = epsilon[1] = epsilon[2] = 1e-6;
                ...
                //common.dom.printout(1);
                common.lat.printout(1);
                
                dstype *y, *x;
                int *a, *b;
                TemplateMalloc(&y, common.dim*common.lat.natom, 1);
                TemplateMalloc(&a, common.lat.natom, 1);                
                cpuAtomLattice(y, a, common.lat.atombasis, common.lat.primitive, common.lat.rotaterow, common.lat.origin, 
                        common.lat.spacing, common.lat.scale, common.lat.atomtype, common.lat.nbasis, 0, common.lat.ilo, 
                        common.lat.ihi, common.lat.jlo, common.lat.jhi, common.lat.klo, common.lat.khi, common.dim);
                
                
                TemplateMalloc(&x, common.dim*common.lat.natom, 1);
                TemplateMalloc(&b, common.lat.natom, 1);                
                int n = cpuAtomAdd(x, b, y, common.dom.h_inv, common.dom.boxlo, common.dom.sublo_lamda,
                    common.dom.subhi_lamda, a, common.dim, 0, common.lat.natom);
                
                cout<<n<<endl;
                printArray2D(x, common.dim, 10, 1);
                error("here");
            }
        }
    }
