...
template <typename T> void gpuSnapComputeUi(T *Stotr, T *Stoti, T *rootpqarray, T *rij, T *wjelem, T *radelem, 
...
template <typename T> void gpuAddWself2Ui(T *Stotr, T *Stoti, T wself, int *idxu_block, 
        int *type, int *map, int *ai, int wselfall_flag, int chemflag, int idxu_max, int nelements, 
         int twojmax, int inum);

template <typename T> void gpuSnapComputeBi(T *blist, T *Stotr, T *Stoti, T *cglist, T *bzero, 
...
template <typename T> void gpuSnapComputeEi(T *eatom, T *Stotr, T *Stoti, T *cglist, 
...
template <typename T> void gpuSnapComputeYi(T *ylist_r, T *ylist_i, T *Stotr, T *Stoti, T *cglist, 
        T* beta, int *idxz, int *idxb_block, int *idxu_block, int *idxcg_block, int twojmax, 
        int idxb_max, int idxu_max, int idxz_max, int nelements, int bnorm_flag, int inum);

template <typename T> void gpuSnapComputeYi(T *ylist_r, T *ylist_i, T *Stotr, T *Stoti, T *cglist, T* coeffelem, 
